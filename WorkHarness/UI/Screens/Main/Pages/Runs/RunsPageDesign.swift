    ...
    enum RunsPageDesign {
        ...
        enum EventRow {
            ...
            static func icon(for type: RunEventType) -> String {
                ...
                case .contextBuildFailed: "exclamationmark.magnifyingglass"
                case .contextRetrievalStarted: "magnifyingglass.circle"
                case .contextRetrievalFinished: "magnifyingglass.circle.fill"
                case .contextCompacted: "rectangle.compress.vertical"
                case .usageUpdated: "gauge.with.dots.needle.67percent"
