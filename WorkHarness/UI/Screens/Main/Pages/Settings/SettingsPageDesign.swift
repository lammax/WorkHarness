...
extension MainScreen {
    enum SettingsPageDesign {
        ...
        enum AppSettings {
            ...
            static let remoteControlStatusTitle = "Server status"
            static let remoteControlDisabledStatus = "Disabled"
            static let remoteControlStartingStatus = "Starting"
            static let remoteControlRunningStatus = "Running"
            static let remoteControlStoppingStatus = "Stopping"
            static let remoteControlFailedStatus = "Failed"
            static let remoteControlUnavailableStatus = "Unavailable"
